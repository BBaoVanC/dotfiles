# Generated by Powerlevel10k configuration wizard on 2024-11-18 at 23:28 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    # move this to end, since moving all right prompt elements to left
    #prompt_char             # prompt symbol
  # move all right prompt elements to left
  #)
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='VI'
